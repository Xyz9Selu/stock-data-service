## Purpose
Define a reproducible local development baseline where PostgreSQL runs via Docker Compose and the service runs locally via `uv`, with clear persistence, migration, and operational workflow expectations.
